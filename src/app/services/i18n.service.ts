...
export class I18nService {
  ...
  photoCaption: 'Author photo',
        ...
        personal: {
          ...
          rolesList: ['UI Engineer','Developer','Designer','Artist','Kusillo','Life lover']
        },
        ...
        projects: [
          { title: 'Kusi Project', year: '2024', role: 'Lead Developer', desc: 'I developed the main platform, integrating CMS and role system.' },
          { title: 'Webadas Project', year: '2022', role: 'UI Engineer', desc: 'Design and prototyping of mobile and desktop experiences.' }
        ],
    ...
    es: {
      ...
      ,
      site: {
        updateNote: 'Este sitio estara acabado en 2026'
      }
      ,
      data: {
        name: 'Pedro Carpio',
  ...
  photoCaption: 'Foto del autor',
        iconCells: ['Versión documento','Educación','LinkedIn','Portafolio','Blog','Compartir'],
        notable: 'Destacado',
        notableItems: {
          fullstack: { title: 'Full-stack', desc: 'JavaScript, Python, Node, Express, Flask' },
        ...
        personal: {
          ...
          phoneHref: '59177914381',
          email: 'pedrocarpiom@gmail.com',
          rolesList: ['Ingeniero UI','Desarrollador','Diseñador','Artista','Kusillo','Amante de la vida']
        },
        hardSkillsTitle: 'Hard Skills',
        hardSkills: {
        ...
        projects: [
          { title: 'Proyecto Kusi', year: '2024', role: 'Lead Developer', desc: 'Desarrollé la plataforma principal, integrando CMS y sistema de roles.' },
          { title: 'Proyecto Webadas', year: '2022', role: 'UI Engineer', desc: 'Diseño y prototipado de experiencias móviles y escritorio.' }
        ],
        softSkillsTitle: 'Soft Skills',
